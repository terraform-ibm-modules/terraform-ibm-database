...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_database_simple_rabbitmq"></a> [database\_simple\_rabbitmq](#module\_database\_simple\_rabbitmq) | ../../modules/rabbitmq | n/a |
...
| Name | Description |
|------|-------------|
| <a name="output_simple_rabbitmq"></a> [simple\_rabbitmq](#output\_simple\_rabbitmq) | simple rabbitmq |
